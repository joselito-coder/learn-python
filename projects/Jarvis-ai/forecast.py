# This code is taken from https://github.com/karthikziffer/weather_forecast/ respository
# Changed the code so that it would return the weather forecast and not pprint it
